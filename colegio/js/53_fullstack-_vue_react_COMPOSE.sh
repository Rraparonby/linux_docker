...
name_file_compose="53_fullstack_vue_react_prod_docker-compose.yml"
path_file_compose="./${name_file_compose}"

#===================== EXPORT / IMPORT =====================

idname_image_db="mariadb:10.7.6-focal"
idname_image_backend="me_colegio_nest_prod:0.1"
idname_image_frontend="me_colegio_react_prod:0.1"    # "me_colegio_react_prod:0.1",    "me_colegio_vue_prod:0.1"

idname_container_db="me_colegio_mariadb_c01"    # NO CAMBIAR NOMBRE (dev/prod)
idname_container_backend="me_colegio_nest_cp01"
idname_container_frontend="me_colegio_vue_cp01"   # "me_colegio_react_cp01"

id_image_db="123456789"
id_image_backend="64a59ea248ff"
id_image_frontend="b43c4f6d00c7"

id_container_db="123456789"
id_container_backend="64a59ea248ff"
...
# SOLO PARA TITLE
idname_image_init="me_colegio_laravel:0.1"        # "me_colegio_laravel:0.1"
idname_container_init="me_colegio_laravel_c01"        # "me_colegio_mariadb_c01",   "me_colegio_laravel_c01",     "me_colegio_vue_c01"

command_init=""      # ls, ip address
