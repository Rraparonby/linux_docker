...
source "../../../source_docker/lib_lote/01_mariadb_laravel_vue/mariadb_laravel_vue_lib_lote.sh"
...
get_menu_opciones_lote() {
    clear
    echo
    echo -e "\t-----------  LOTE (MARIADB - PHP - LARAVEL) - HOST-PC "
    ...
    echo -e "\t-----------------------------------------"
    echo -e "\t2. Ejecutar Comando Container LARAVEL Interactivo GENERAL (docker exec -it)"
    echo -e "\t3. Ejecutar Comando Container LARAVEL GENERAL Colegio PARAMETRO (docker exec -it)"
